...
class FloatingWidgetService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        // Get screen capture permission data
    ...
    private fun setupClickListeners() {
        binding.apply {
            ...
            btnRecordPattern.setOnClickListener {
                Toast.makeText(this@FloatingWidgetService, "Recording pattern...", Toast.LENGTH_SHORT).show()
                // TODO: Implement pattern recording
            }
        }
    }
    ...
    private fun updateWidgetUI() {
        binding.apply {
            ...
            btnToggleLearning.setBackgroundColor(
                if (isLearningMode) 
            ...
            btnToggleAuto.setBackgroundColor(
                if (isAutoMode) 
            ...
            // Disable auto mode if learning mode is on
    ...
    private fun startLearningMode() {
        Toast.makeText(this, "Learning Mode Activated - Watching your actions...", Toast.LENGTH_SHORT).show()
    ...
    private fun stopLearningMode() {
        ...
        // ML service will continue running but will stop active learning
    }
    ...
    private fun startAutoMode() {
        ...
        Toast.makeText(this, "Auto Mode Activated - AI is in control", Toast.LENGTH_SHORT).show()
    ...
    private fun stopAutoMode() {
        Toast.makeText(this, "Auto Mode Stopped - Manual control restored", Toast.LENGTH_SHORT).show()
    ...
    private fun isAccessibilityServiceEnabled(): Boolean {
        ...
        return try {
            val service = "com.aiautomation.assistant/.service.AutomationAccessibilityService"
